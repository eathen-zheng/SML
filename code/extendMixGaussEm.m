%% extendMixGaussEm: Perform extend EM algorithm for fitting the Gaussian mixture model.
 %% Input:
 %% X: [d, N], data matrix, Mu of n Gaussian mixture models
 %%    generated by standard EM algorithm, N = K * n where
 %%    K is number of components in standard EM algorithm
 %%    n is number of standard Gaussian mixture models
 %% M: [1, 1], number of components in extend EM algorithm 
 %% prePi: [1, N], Pi of n Gaussian mixture models generated by standard EM algorithm
 %% preSigma: [d, d, N], Sigma of n Gaussian mixture models generated by standard EM algorithm
 %% Output:
 %% Mu: [d, M], Mu of a Gaussian mixture models generated by extend EM algorithm
 %% Sigma: [d, d, M], Sigma of a Gaussian mixture models generated by extend EM algorithm
 %% Pi: [1, M], Pi of a Gaussian mixture models generated by extend EM algorithm
